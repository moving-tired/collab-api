...
config :collab, CollabWeb.Endpoint,
  ...
  render_errors: [view: CollabWeb.ErrorView, accepts: ~w(json)],
  pubsub: [name: Collab.PubSub, adapter: Phoenix.PubSub.PG2],
  live_view: [signing_salt: "9zXzGEtt"]
...
config :collab, CollabWeb.Guardian,
  issuer: "collab",
